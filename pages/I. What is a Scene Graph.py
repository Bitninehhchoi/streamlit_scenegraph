...
def Intro():
    ...
    st.markdown("### <h1 style='text-align: center; font-size:350%'>Scene Graph란?</h1>", unsafe_allow_html=True)
...
def Practice1():
    ...
    st.markdown(f"""## <h1 style='text-align: center; font-size:150%'>{ttl_txt1_1}</h1>""", 
    unsafe_allow_html=True)
    st.text("")
